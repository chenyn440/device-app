...
namespace {
struct qt_meta_tag_ZN9deviceapp15SettingsServiceE_t {};
} // unnamed namespace

template <> constexpr inline auto deviceapp::SettingsService::qt_create_metaobjectdata<qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "deviceapp::SettingsService"
    };
    ...
    return QtMocHelpers::metaObjectData<SettingsService, qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject deviceapp::SettingsService::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>.metaTypes,
    nullptr
} };

void deviceapp::SettingsService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
...
const QMetaObject *deviceapp::SettingsService::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *deviceapp::SettingsService::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9deviceapp15SettingsServiceE_t>.strings))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int deviceapp::SettingsService::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    return _id;
}
